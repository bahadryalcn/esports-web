...
export async function getHomepage(
  locale: string = 'tr'
): Promise<TinaResponse<HomepageResponse>> {
  try {
...
export async function getSettings(
  locale: string = 'tr'
): Promise<TinaResponse<SettingsResponse>> {
  try {
...
export async function getNavigation(
  locale: string = 'tr'
): Promise<TinaResponse<NavigationResponse>> {
  try {
...
export async function getNews(
  locale: string = 'tr',
  limit?: number
): Promise<TinaResponse<NewsListResponse>> {
  try {
...
export async function getPlayers(
  locale: string = 'tr',
  limit?: number
): Promise<TinaResponse<PlayersListResponse>> {
  try {
...
export async function getServices(
  locale: string = 'tr'
): Promise<TinaResponse<ServicesListResponse>> {
  try {
...
export async function getMatches(
  locale: string = 'tr',
  limit?: number
): Promise<TinaResponse<MatchesListResponse>> {
  try {
...
export async function getAbout(
  locale: string = 'tr'
): Promise<TinaResponse<AboutResponse>> {
  try {
    ...
    data: {
      homepage: {
        seo: {
          ...
          description:
            'E-spor dünyasında profesyonel takım yönetimi, oyuncu gelişimi ve danışmanlık hizmetleri.',
        ...
        components: [
          ...
          },
          {
            ...
            title: 'Hizmetlerimiz',
            subtitle:
              'E-spor dünyasında başarıya ulaşmanız için ihtiyacınız olan tüm hizmetler',
          },
          {
            _template: 'about',
            title: 'Hakkımızda',
  ...
  return {
    data: {
      navigation: {
        ...
        footer: {
          aboutText:
            'AIM Agency olarak, e-spor dünyasında profesyonel hizmetler sunuyoruz.',
    ...
    data: {
      about: {
        seo: {
          ...
          description:
            'AIM Agency olarak e-spor dünyasında yılların deneyimi ile profesyonel takım yönetimi, oyuncu gelişimi ve danışmanlık hizmetleri sunuyoruz.',
          keywords:
            'e-spor, takım yönetimi, oyuncu gelişimi, AIM Agency, profesyonel gaming',
          ...
          sections: [
            {
              title: 'Misyonumuz',
              content:
                'E-spor dünyasında profesyonel standartları yükseltmek ve oyuncularımızın potansiyellerini en üst seviyeye çıkarmak.',
              icon: 'target',
            },
            {
              title: 'Vizyonumuz',
              content:
                "Türkiye'nin en güvenilir e-spor ajansı olmak ve global e-spor ekosisteminde söz sahibi olmak.",
              icon: 'eye',
            },
            {
              title: 'Değerlerimiz',
              content:
                'Şeffaflık, profesyonellik, sürekli gelişim ve oyuncu odaklı yaklaşım temel değerlerimizi oluşturuyor.',
              icon: 'heart',
            },
          ],
        },
          ...
          items: [
            {
              ...
              description:
                'Türkiye şampiyonluğu ve uluslararası turnuvada 3. sıra',
