...
export const useAboutValues = (
  customValues?: TinaCMSValue[] | AboutValue[]
): AboutValue[] => {
  const defaultValues: AboutValue[] = [
    ...
    },
    {
      ...
      title: 'Başarı',
      description:
        'Oyuncularımızın ve takımlarımızın başarısı bizim başarımızdır.',
    },
    {
      icon: Zap,
      title: 'İnovasyon',
      description:
        'Sürekli gelişim ve yenilikçi yaklaşımlarla sektörde öncüyüz.',
    },
    {
      icon: Users,
      title: 'Takım Çalışması',
      description:
        'Güçlü ekip ruhu ile birlikte daha büyük başarılar elde ediyoruz.',
    },
  ];
